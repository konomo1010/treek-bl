...
void UpdateSignalValidity()
{
    ...
    if (longSignalConfirmed)
    {
        ...
        {
            // 更新maxHigh值
            if (lastCompletedClose > maxHigh)
            {
                maxHigh = lastCompletedClose;
            }
    ...
    else if (shortSignalConfirmed)
    {
        ...
        {
            // 更新minLow值
            if (lastCompletedClose < minLow)
            {
                minLow = lastCompletedClose;
            }
